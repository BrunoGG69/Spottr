...
export default function Hero() {
    ...
    return (
        <section ref={ref} className="relative w-full min-h-screen flex items-center bg-[#080808] overflow-hidden">
                ...
                {!introComplete && (
                    ...
                    >
                        <div className="w-full h-full">
                            <TextHoverEffect text="SPOTTR" duration={0.3} showStroke={false} strokeColor="url(#textGradient)" />
                        </div>
                    </motion.div>
                )}
            </AnimatePresence>
            ...
            <motion.div
                className="relative z-10 w-1/2 px-32 pt-10"
            ...
            >
                ...
                <p className="text-white mt-3 text-lg leading-relaxed max-w-md">
                    Spottr is an open-source indoor presence tracking system built on ESP32-C3 and Bluetooth Low Energy.
                ...
                <div className="flex items-center gap-4 mt-6">
                    <motion.div
                        ...
                        whileTap={{scale: 0.97}}
                        className="px-8 py-3 bg-cyan-500 text-black font-semibold rounded hover:bg-cyan-400 transition-colors"
                    >
                        Get Started
                    </motion.div>
                    <motion.a
                        ...
                        className="px-8 py-3 border border-white/20 text-white rounded hover:border-white/50 transition-colors"
                    >
                        View on GitHub
                    </motion.a>
                </div>
            ...
            {/* 3D Model of Spottr */}
            <motion.div
                className="w-1/2 h-screen relative z-10"
                style={{y: modelY}}
